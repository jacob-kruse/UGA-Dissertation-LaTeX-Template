...
% The following enables tagging for the PDF, remove if you do not care about PDF accessibility
\DocumentMetadata{
  tagging=on,
...
% Set title and author meta data for PDF accessibility and set border colors after being muted by 'DocumentMetadata'
\hypersetup{
  pdftitle={\doctitle},
  pdfauthor={\docauthor},
  linkbordercolor=red,
